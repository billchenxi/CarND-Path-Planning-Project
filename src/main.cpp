...
//                                }
                    ...
                    if(prev_size < 2){
                        ...
                        // creating path tangent to the car
                        double prev_car_x = car_x - cos(car_yaw); // go back in time to calculate the point previous step
                    ...
                    // use the previous path's end point as starting reference
                        ...
                        // Use two points that make the path atangent to the previous paths end point
                    ...
                    //In stead of loopin gthrough and creating 50 of them, just create 3: 30, 60, 90.
                    ...
                    // shift rotation, to make the x,y direction to car coordinate
